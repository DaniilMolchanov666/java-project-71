...
class AppTest {
    ...
    private static final File FILE_JSON_FIRST = new File("./src/test/resources/FileForTesting1.json");

    private static final File FILE_JSON_SECOND = new File("./src/test/resources/FileForTesting2.json");

    private static final File FILE_YML_FIRST = new File("./src/test/resources/FileForTesting3.yml");

    private static final File FILE_YML_SECOND = new File("./src/test/resources/FileForTesting4.yml");
